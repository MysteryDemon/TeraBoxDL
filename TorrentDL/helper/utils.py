from TorrentDL import LOGS, UPDATE_INTERVAL, MIN_PROGRESS_STEP, SPLIT_SIZE, Var, aria2, resolver, active_downloads, last_upload_update, last_upload_update, last_upload_progress, last_upload_speed
